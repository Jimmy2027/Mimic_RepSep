...
experiment_dir = Path(config['experiment_dir']).expanduser()
flags_path = experiment_dir / 'flags.rar'
...
state_dict_path = experiment_dir / 'checkpoints/0149/mm_vae'
...
def create_cond_gen_plot(in_mods='Lateral_PA', nbr_samples=5):
    ...
    _ = mimic.utils.plot.create_fig(os.path.join(mimic_experiment.flags.dir_cond_gen, f'{in_mods}.png'),
                                    img_data=rec,
